...
g++ -fpermissive testOfficeDistraction.cpp ../Arduino/*.cpp $(cat office_distraction_files.txt) -o test_office_distraction2 -lncurses -I ./ -I ../../arduino-libs/OfficeDistraction  -I ../Arduino # -I /usr/local/arduino-1.0.2/hardware/tools/avr/lib/avr/include
